...
mixin _$Product {
 ...
 String get id; String get name; String get description; DateTime? get createdAt; int? get price; bool? get isSale; int? get stock; double? get saleRate; String? get imageUrl;
...
@useResult
$Res call({
 String id, String name, String description, DateTime? createdAt, int? price, bool? isSale, int? stock, double? saleRate, String? imageUrl
});
...
class _Product extends Product {
  const _Product({required this.id, required this.name, required this.description, this.createdAt, this.price, this.isSale, this.stock, this.saleRate, this.imageUrl}): super._();
